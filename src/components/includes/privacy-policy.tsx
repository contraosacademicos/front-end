				...
				<div className="mt-6 flex w-full max-w-[1000px] flex-col items-center rounded-3xl border border-[#716F6F] bg-[#252525]">
					...
					<div className="flex flex-col gap-3 px-24 pb-24 pt-10 text-white/60">
						<p className="text-base">
							...
							coletar no site https://contraosacademicos.com.br, e
							outros sites que possuímos e operamos. Nos
							comprometemos com a transparência, segurança e
							confidencialidade dos dados pessoais de nossos
							visitantes, leitores e clientes. Todas as
							informações coletadas são utilizadas unicamente para
							proporcionar uma melhor experiência e cumprir com as
						...
						<p className="text-base">
							...
							coleta pode incluir: nome, e-mail, número de
						...
						<p className="text-base">
							...
							ao navegar em nosso site. Utilizamos ferramentas
							como Google Analytics para entender o comportamento
						...
						<p className="text-base">
							...
							personalizar conteúdos, sugerir leituras, otimizar a
							navegação, processar compras de livros, emitir notas
						...
						<p className="text-base">
							...
							cumprimento de contrato ou necessidade técnica (como
							provedores de pagamento e envio) poderemos
							compartilhar dados — sempre com os mesmos padrões de
						...
						<p className="text-base">
							...
							lembrar preferências de leitura, manter o usuário
						...
						<p className="text-base">
							...
							cookies analíticos (nos ajudam a entender o tráfego
							e comportamento do usuário). Em hipótese alguma
						...
						<p className="text-base">
							...
							funcionalidades do site podem não funcionar como
							esperado.
						</p>
						<div className="mb-4"></div>
						...
						<p className="text-base">
							...
							consentimento para o uso de determinados dados,
						...
						<p className="text-base">
							...
							total à sua liberdade de escolha e pela integridade
							de suas informações.
						</p>
						<div className="mb-4"></div>
						...
						<p className="text-base">
							...
							notificaremos por e-mail (caso você esteja
							cadastrado) ou por aviso em destaque no próprio
							site.
						</p>
						<div className="mb-4"></div>
						...
						<p className="text-base">
							...
							e-mail:{" "}
							<strong>contato@contraosacademicos.com.br</strong>.
							Teremos prazer em atendê-lo com total atenção e
